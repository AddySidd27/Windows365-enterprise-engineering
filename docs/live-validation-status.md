...
|---|---|---|
| [UC-01](../use-cases/UC-01-tenant-readiness-and-pilot-design.md) | An assigned pilot user has an Enterprise Cloud PC; policy is visible in [pilot record](../evidence/UC-02-2026-09-24-portal-check.md) | License entitlement/role screenshots and isolated group membership audit |
...
| [UC-03](../use-cases/UC-03-network-architecture.md) | Web connection to existing Cloud PC worked | Hosted network route/DNS evidence; ANC and hybrid variants need separate infrastructure |
...
| [UC-09](../use-cases/UC-09-conditional-access.md) | None published from this Enterprise pilot | What If, report-only and relevant sign-in logs |
...
| [UC-12](../use-cases/UC-12-monitoring-and-troubleshooting.md) | Initial web connection returned HTTP 502; retry connected in [pilot record](../evidence/UC-02-2026-09-24-portal-check.md) | Complete incident with correlated logs, root cause and recovery proof |
| [UC-13](../use-cases/UC-13-image-and-application-baseline.md) | Existing policy uses a gallery image in [pilot record](../evidence/UC-02-2026-09-24-portal-check.md) | Image release/version test and custom image only if required |
